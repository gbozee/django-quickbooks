"""
Django settings for django_quickbooks project.
...
SECRET_KEY = '3zw)50z6u!ro(&@tqv@znvn1qes876#mpn#e#@h5nf3i0h+co4'
...
ROOT_URLCONF = 'django_quickbooks.urls'
...
WSGI_APPLICATION = 'django_quickbooks.wsgi.application'
...
# HUBSPOT_EMAIL_WEBHOOK = os.getenv("MAILGUN_WEBHOOK_DOMAIN")
